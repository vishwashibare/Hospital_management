            ...
            <center>
              ...
              <form class="form-group" method="POST" action="func.php">
                ...
                <!-- email -->
                  ...
                  <div class="col-md-8"><input type="text" name="email" value="<?php if(isset($_COOKIE["email"])) { echo $_COOKIE["email"]; } ?>"  class="form-control"
                ...
                <!-- password -->
                  ...
                  <div class="col-md-8" style="margin-top: 8%"><input type="password" class="form-control"
                      name="password2" value="<?php if(isset($_COOKIE["password2"])) { echo $_COOKIE["password2"]; } ?>"  placeholder="enter password" required /></div><br><br><br>
                </div>
                <!-- remember me  -->
