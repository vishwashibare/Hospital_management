                    ...
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <form method="post" action="func2.php">
                            <div class="row register-form">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Last Name *" name="lname" value="<?php if(isset($_COOKIE["lname"])) { echo $_COOKIE["lname"]; } ?>"
                                            onkeydown="return alphaOnly(event);" required />
                                    </div>

                                    <div class="form-group">
                                        <input type="tel" minlength="10" maxlength="10" name="contact" value="<?php if(isset($_COOKIE["contact"])) { echo $_COOKIE["contact"]; } ?>"
                                            class="form-control" placeholder="Your Phone *" />
                                    </div>
                                    <div class="form-group">
                                        <input type="password" class="form-control" id="cpassword"
                                            placeholder="Confirm Password *" name="cpassword" value="<?php if(isset($_COOKIE["cpassword"])) { echo $_COOKIE["cpassword"]; } ?>" onkeyup='check();'
