            ...
            <center>
              ...
              <form class="form-group" method="POST" action="func1.php">
                ...
                <!-- email -->
                  ...
                  <div class="col-md-8"><input type="text" name="username3"  class="form-control"
                      placeholder="username *" required /></div><br><br>
                <!-- password -->
                  ...
                  <div class="col-md-8" style="margin-top: 8%"><input type="password" class="form-control"
                      name="password3"   placeholder="password *" required /></div><br><br><br>
                </div>
                <!-- login button -->
                <div class="row">
                  <div class="col-md-4" style="padding-left: 160px;margin-top: 10%">
                    <center><input type="submit" id="inputbtn" name="docsub1" value="Login" class="btn btn-primary">
                    </center>
                  </div>
                    </div>
